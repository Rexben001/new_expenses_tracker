...
export const handler = makeHandler({ shoppingDb: makeDbService(client, process.env.TABLE_NAME!), inventoryDb: makeDbService(client, process.env.FOOD_ITEMS_TABLE_NAME!) });
